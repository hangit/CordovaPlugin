...
module.exports = function(context) {
    ...
    child_process.exec("npm --prefix " + pluginDir + " install " + pluginDir, function(){
      ...
      xcodeProject.parse(function(err) {
          ...
          if (err){
              deferral.reject("HangitPlugin - after_plugin_install: " + JSON.stringify(err));
              return;
          }
          ...
          var frameworkPath = cfg.name() + "/Plugins/com.hangit.cordova/";
          xcodeProject.removeFramework(frameworkPath + "HangitSDK.framework", {customFramework: true, embed: true, link: true});
          ...
          //Add ShellScript to remove simulator libraries -> http://ikennd.ac/blog/2015/02/stripping-unwanted-architectures-from-dynamic-libraries-in-xcode/
          ...
          // This is critical to include, otherwise the library loader cannot find the dynamic Hangit libs at runtime on a device.
          ...
          xcodeProject.addFramework(frameworkPath + "HangitSDK.framework", {customFramework: true, embed: true, link: true});
